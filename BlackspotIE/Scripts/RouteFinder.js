...
function showGreenToastWithSpot(counter) {
    $('.toast').remove();
    if (counter > 1) {
        $('.map_box_container').before('<div class="toast add-margin"> <div class="toast__icon"> <i class="fa fa-check-circle" aria-hidden="true" style="color: green"></i> </div><div class="toast__content"> <p class="toast__type">Success</p><p class="toast__message">The algorithm has found a safe route without high risk black spot for you in ' + counter + ' tries, however there is still some mid-risk black spots on the route, check them in the list below. And we also show a comparision of the result(green) with the shortest route(blue)</p></div><div class="toast__close"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.642 15.642" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 15.642 15.642"> <path fill-rule="evenodd" d="M8.882,7.821l6.541-6.541c0.293-0.293,0.293-0.768,0-1.061 c-0.293-0.293-0.768-0.293-1.061,0L7.821,6.76L1.28,0.22c-0.293-0.293-0.768-0.293-1.061,0c-0.293,0.293-0.293,0.768,0,1.061 l6.541,6.541L0.22,14.362c-0.293,0.293-0.293,0.768,0,1.061c0.147,0.146,0.338,0.22,0.53,0.22s0.384-0.073,0.53-0.22l6.541-6.541 l6.541,6.541c0.147,0.146,0.338,0.22,0.53,0.22c0.192,0,0.384-0.073,0.53-0.22c0.293-0.293,0.293-0.768,0-1.061L8.882,7.821z"></path></svg> </div></div>');

    }
    else {
        $('.map_box_container').before('<div class="toast add-margin"> <div class="toast__icon"> <i class="fa fa-check-circle" aria-hidden="true" style="color: green"></i> </div><div class="toast__content"> <p class="toast__type">Success</p><p class="toast__message">The algorithm has found a safe route without high risk black spot for you in ' + counter + ' tries, however there is still some mid-risk black spots on the route, check them in the list below.</p></div><div class="toast__close"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.642 15.642" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 15.642 15.642"> <path fill-rule="evenodd" d="M8.882,7.821l6.541-6.541c0.293-0.293,0.293-0.768,0-1.061 c-0.293-0.293-0.768-0.293-1.061,0L7.821,6.76L1.28,0.22c-0.293-0.293-0.768-0.293-1.061,0c-0.293,0.293-0.293,0.768,0,1.061 l6.541,6.541L0.22,14.362c-0.293,0.293-0.293,0.768,0,1.061c0.147,0.146,0.338,0.22,0.53,0.22s0.384-0.073,0.53-0.22l6.541-6.541 l6.541,6.541c0.147,0.146,0.338,0.22,0.53,0.22c0.192,0,0.384-0.073,0.53-0.22c0.293-0.293,0.293-0.768,0-1.061L8.882,7.821z"></path></svg> </div></div>');
...
function showGreenToastWithoutSpot(counter) {
    $('.toast').remove();
    $('.map_box_container').before('<div class="toast add-margin"> <div class="toast__icon"> <i class="fa fa-check-circle" aria-hidden="true" style="color: green"></i> </div><div class="toast__content"> <p class="toast__type">Success</p><p class="toast__message">The algorithm has found a safe route without any risky blackspot for you in ' + counter + ' tries, your road is safe and good to go. </p></div><div class="toast__close"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.642 15.642" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 15.642 15.642"> <path fill-rule="evenodd" d="M8.882,7.821l6.541-6.541c0.293-0.293,0.293-0.768,0-1.061 c-0.293-0.293-0.768-0.293-1.061,0L7.821,6.76L1.28,0.22c-0.293-0.293-0.768-0.293-1.061,0c-0.293,0.293-0.293,0.768,0,1.061 l6.541,6.541L0.22,14.362c-0.293,0.293-0.293,0.768,0,1.061c0.147,0.146,0.338,0.22,0.53,0.22s0.384-0.073,0.53-0.22l6.541-6.541 l6.541,6.541c0.147,0.146,0.338,0.22,0.53,0.22c0.192,0,0.384-0.073,0.53-0.22c0.293-0.293,0.293-0.768,0-1.061L8.882,7.821z"></path></svg> </div></div>');
    $('.toast').focus();
    $('.toast__close').on("click", function (e) {
        e.preventDefault();
        var parent = $(this).parent('.toast');
